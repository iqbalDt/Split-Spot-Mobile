      ...
      body: Stack(children: [
        ...
        SafeArea(child: FadeTransition(opacity: _fadeAnim, child: SlideTransition(position: _slideAnim,
          child: SingleChildScrollView(child: Padding(padding: const EdgeInsets.symmetric(horizontal: 28, vertical: 40), child: Column(children: [
            ...
            const SizedBox(height: 24),
            Center(child: Text('Welcome Back', style: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.bold, color: AppColors.textDark))),
            const SizedBox(height: 8),
            Center(child: Text('Masuk ke akun Anda untuk melanjutkan', style: GoogleFonts.poppins(fontSize: 14, color: AppColors.textSecondary))),
